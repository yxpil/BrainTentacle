...
const BASE = `https://github.com/yxpil/BreanInTentacle/releases/download/v${VERSION}`;
...
main().catch((e) => {
  ...
  console.error("[bit-agent] 可到 https://github.com/yxpil/BreanInTentacle/releases 手动下载");
