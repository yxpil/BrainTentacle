...
const BASE = `https://github.com/yxpil/BrainTentacle/releases/download/v${VERSION}`;
...
main().catch((e) => {
  ...
  console.error("[bit-agent] 可到 https://github.com/yxpil/BrainTentacle/releases 手动下载");
